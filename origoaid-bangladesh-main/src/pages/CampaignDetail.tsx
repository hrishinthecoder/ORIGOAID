...
export default function CampaignDetail() {
  ...
  const { campaigns, donations, bookmarks, toggleBookmark } = useStore();
          ...
          <div className="grid lg:grid-cols-[1fr_400px] gap-8">
            <article>
              ...
              <div className="card-elevated p-5 mb-6 flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-brand-emerald-dark grid place-items-center text-white font-bold">
